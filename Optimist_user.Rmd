...
setDT(duplicates_overtime_table_grouped)

plot_ly(data = duplicates_overtime_table_grouped[order(duplicates_overtime_table_grouped$DATES),], 
        x = ~DATES, 
        y = ~count,
...
If we look at reattestations over time, we see that, on average, people who come back to reattest get a higher score by .2 points! this is an encouraging finding because, while there are people who are spamming/botting the attestation, users were incentivised to return to the app and reattest with a higher score after using Optimism in a new way! 
