...
Looking at all Optimist attestors between December 14, 2022 (date of launch) and January 30, 2023 (date of analysis), there have been `r format(sum(flipside$num_attestations), big.mark=",")` attestations!
...
full_attestation_table <- auto_paginate_query(full_attestation_table_query, 
...
plot_ly(data = duplicates_overtime_table_grouped, 
        ...
        type = "bar") %>% 
  layout(
    title = "Duplicate Attestation Percent Over Time",
    xaxis = list(title = "Date"),
